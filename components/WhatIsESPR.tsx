export default function WhatIsESPR() {
  ...
  return (
    <section id="what" className="pt-12 pb-8">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-16">
          {pillars.map(p => (
            <div key={p.title} className="card-hover rounded-2xl p-8 bg-white shadow-sm border border-gray-100">
              ...
              <h3 className="text-xl font-bold mb-3" style={{ color: '#241538', fontFamily: "'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif" }}>
                {p.title}
              </h3>
              <p className="text-sm leading-relaxed" style={{ color: '#6b7280', fontFamily: 'Raleway, sans-serif' }}>
                {p.desc}
              </p>
            </div>
          ))}
        ...
        <div className="rounded-2xl p-8 md:p-10 text-center"
          style={{ backgroundColor: '#f5f3ff', border: '1px solid rgba(111,70,152,0.15)' }}>
          <p className="text-lg font-semibold tracking-wide uppercase text-sm mb-3"
            style={{ color: '#a883c9', fontFamily: 'Raleway, sans-serif', letterSpacing: '0.1em' }}>
            The Core Shift
          </p>
          <p className="text-2xl md:text-3xl font-bold" style={{ color: '#241538', fontFamily: "'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif" }}>
            For steel manufacturers, ESPR means every product must move from being{' '}
            <span style={{ color: '#6f4698' }}>document-backed</span> to{' '}
            <span style={{ color: '#6f4698' }}>data-backed.</span>
          </p>
        </div>
      </div>
    </section>
