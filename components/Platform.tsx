export default function Platform() {
  ...
  return (
    <section id="platform" className="py-24" style={{ background: '#f8fafc' }}>
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mt-16 text-center flex justify-center">
          <div className="relative inline-flex flex-col md:flex-row items-center gap-6 rounded-3xl px-10 py-8 border shadow-xl transition-all duration-300 hover:shadow-2xl"
            style={{ background: 'linear-gradient(135deg, #ffffff, #f0f4ff)', borderColor: 'rgba(111,70,152,0.1)' }}>
            {/* Background Glow */}
            ...
            <div className="text-left max-w-lg">
              <h4 className="text-xl font-bold mb-2" style={{ color: '#241538', fontFamily: 'Syne, sans-serif' }}>
                Ready to secure your EU market access?
              </h4>
              <p className="text-sm font-medium text-gray-600" style={{ fontFamily: 'DM Sans, sans-serif' }}>
