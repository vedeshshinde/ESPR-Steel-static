      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
              ...
              {[
                ...
                <div key={item.step} className="flex gap-4">
                  <span className="text-sm font-bold w-8 flex-shrink-0 mt-0.5"
                    style={{ color: '#8d3f98', fontFamily: 'Syne, sans-serif' }}>
                    {item.step}
                  </span>
                  <div>
          ...
          <div className="rounded-2xl p-8 border border-gray-100 shadow-sm bg-white">
            {!submitted ? (
              <>
                <h3 className="text-xl font-bold mb-6" style={{ color: '#241538', fontFamily: 'Syne, sans-serif' }}>
                ...
                <div className="space-y-4">
                  ...
                  <button
                    ...
                    style={{
                      background: 'linear-gradient(135deg, #6f4698, #241538)',
              ...
              <div className="text-center py-12">
                ...
                <h3 className="text-xl font-bold text-gray-800 mb-2" style={{ fontFamily: 'Syne, sans-serif' }}>
                  Thank you, {form.name}!
                </h3>
