    ...
    >
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <a href="#" className="flex items-center gap-2.5">
          ...
          <div>
            <span className="font-bold text-sm leading-tight block" style={{ fontFamily: 'Syne, sans-serif', color: '#241538' }}>
              Emertech
            </span>
            <span className="text-xs leading-tight block" style={{ color: '#6b7b8d', fontFamily: 'DM Sans, sans-serif' }}>
              ESPR Steel Platform
            </span>
          </div>
        </a>
        ...
        <nav className="hidden md:flex items-center gap-8">
          {links.map(link => (
            <a
              ...
              style={{ color: scrolled ? '#374151' : '#241538', fontFamily: 'DM Sans, sans-serif' }}
            >
              {link.label}
            </a>
          ))}
        ...
        <div className="hidden md:flex items-center gap-3">
          <a
            ...
            style={{ color: '#6f4698', fontFamily: 'DM Sans, sans-serif' }}
          >
            Assess Readiness
          </a>
          <a
            ...
            style={{ background: 'linear-gradient(135deg, #6f4698, #241538)', fontFamily: 'DM Sans, sans-serif' }}
          >
            Book a Demo
          </a>
        </div>
      ...
      {mobileOpen && (
        <div className="md:hidden bg-white border-t border-gray-100 px-6 py-4 space-y-3">
          ...
          <a
            ...
            style={{ background: 'linear-gradient(135deg, #6f4698, #241538)' }}
            onClick={() => setMobileOpen(false)}
          >
            Book a Demo
          </a>
